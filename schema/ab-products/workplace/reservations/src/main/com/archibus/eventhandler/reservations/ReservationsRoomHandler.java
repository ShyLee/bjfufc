                ...
                try {
                    sql =
                            " SELECT "
                                    ...
                                    + "bl.ctry_id as ctry_id, bl.bl_id as bl_id,fl_id,rm_id,config_id,rm_arrange_type_id,status, "
                                    + "(guests_internal+guests_external) as group_size,guests_external"
                                    + " FROM reserve_rm, bl " + " WHERE res_id = " + reservationId
                ...
                try {
                    sql =
                            " SELECT "
                                    ...
                                    + " resource_id,quantity,bl.bl_id,fl_id,rm_id,status "
                                    + " FROM reserve_rs, bl " + " WHERE res_id = " + reservationId
                ...
                if (single.toUpperCase().equals("YES")) {
                    ...
                    sql =
                            " SELECT res_id, res_parent FROM reserve "
                                    ...
                                    + reservationId
                                    + " ) AND NOT (status='Cancelled' OR status='Rejected')";
                }
