var abDataBlMngtChgController = View.createController('abDataBlMngtChgController',{
	...
	tsBlGrid_onCheack: function(){
		...
		if(this.selectedRow != null){
			...
			var res = new Ab.view.Restriction();
    		res.addClause('sc_bl_value_chg.bl_id', blId, '=');
			View.openDialog('asc-bj-usms-data-bl-area-value-chg-history.axvw', res, true, {
			        width: 800,
			        height: 600,
			        bl_id: blId,
			        bl_name: blName,
			...
			View.openDialog('asc-bj-usms-data-bl-area-value-chg-history.axvw', null, true, {
		        width: 800,
		        height: 600,
		        closeButton: false
		});
	...
	tsBlConsole_onClear:function(){
		this.tsBlGrid.refreshClearAllFilters();
	}
});