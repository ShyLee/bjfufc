var abDataParcellandMngtChgController = View.createController('abDataParcellandMngtChgController',{
	...
	afterInitialDataFetch: function(){
		...
		this.marketForm.enableField('sc_land_change.value_market',false);
		if(this.flag == "change"){
...
//				res.addClause('sc_land_change.land_code',this.landCode,'=');
	...
	change:function(){
		var type = this.marketForm.getFieldValue("sc_land_change.type");
		if(type == 1){
			this.marketForm.enableField('sc_land_change.value_market',false);
			this.marketForm.enableField('sc_land_change.area_market',true);
		}else if(type == 2){
			this.marketForm.enableField('sc_land_change.value_market',true);
			this.marketForm.enableField('sc_land_change.area_market',false);
		}else{
			this.marketForm.enableField('sc_land_change.value_market',true);
			this.marketForm.enableField('sc_land_change.area_market',true);
		}
