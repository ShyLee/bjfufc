    ...
    onAddNewButtonPush: function(menuItemId){
        ...
        if (this.curTreeNode) {
            ...
            switch (nodeLevelIndex) {
                ...
                case 1: //pr
                    ...
                    break;
                case 2: //bl
                    siteId = this.curTreeNode.data["sc_gzw.site_id"];
                    propertyId = this.curTreeNode.data["sc_gzw.pr_id"];
                    buildingId = this.curTreeNode.data["sc_gzw.bl_id"];
                    break;
            }
        }
        var regnId = "";
        ...
        switch (menuItemId) {
            ...
            case "BUILDING":
                ...
                restriction.addClause("sc_gzw.site_id", siteId, '=');
                restriction.addClause("sc_gzw.pr_id", propertyId, '=');
