	        ...
	        View.confirm(confirmMessage, function(button){
	            if (button == 'yes') {
	            	try {
	            		...
	            		var	jobId = Workflow.startJob('AbSpaceRoomInventoryBAR-ParcellandXiaZhang-parcellandXiaZhang',record);
	            		View.openJobProgressBar('宗地下账-进度条', jobId, '', function(status) {
