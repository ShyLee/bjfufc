...
var abScRptRmcatTypebyBl = View.createController('abScRptRmcatTypebyBl', {
	...
	afterViewLoad:function(){
		...
		this.abScRmcatTypeRptSite_tree.addParameter('sitetIdSql', "");
        this.abScRmcatTypeRptSite_tree.addParameter('blId', "IS NOT NULL");
        this.abScRmcatTypeRptSite_tree.createRestrictionForLevel = createRestrictionForLevel;
	},
	...
	updateRowNumberForRmcattypeReport: function(){
	 ...
	 sbfFilterPanel_onShow: function(){
	        ...
	        this.abScRmcatTypeRptPanel.show(false);
	    },
	    refreshTreeview: function(){
	        var consolePanel = this.sbfFilterPanel;
	        var treePanel = View.panels.get("abScRmcatTypeRptSite_tree");
...
function onClickBlNode(){
	...
	abScRptRmcatTypebyBl.blName = blName;
