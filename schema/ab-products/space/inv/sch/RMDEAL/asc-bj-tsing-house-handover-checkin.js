...
//		this.ts_handover_form.setFieldValue("ts_handover.handover_id","");
	...
	//导出报表
	ts_handover_form_onCheckout: function(){
		var handover_id=this.ts_handover_form.getFieldValue('ts_handover.handover_id');
		if(handover_id==null){
			View.alert('缺少交接单号，操作失败！');
			return;
		}
