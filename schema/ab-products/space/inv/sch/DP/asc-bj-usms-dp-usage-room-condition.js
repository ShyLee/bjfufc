...
var roomUsageByDpController = View.createController('roomUsageByDpController', {
    ...
    consolePanel_onClear:function(){
    	this.bu_tree.refreshClearAllFilters();
    }
...
function afterGeneratingTreeNode(treeNode){
    ...
    if (treeNode.level.levelIndex == 1) {
        ...
        labelText1 = "<span class='" + treeNode.level.cssClassName + "'>" + dvName + "</span> ";
        labelText1 = labelText1 + "<span class='" + treeNode.level.cssClassName + "'>" + dvId + "</span> ";
        treeNode.setUpLabel(labelText1);
    }
...
function addTotalRow(parentElement){
    ...
    addColumn(gridRow, 1, getMessage('合计'));
    // column 4: total room
