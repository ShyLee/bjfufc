...
var asgnCreateReqSelectTypeTabController = View.createController("asgnCreateSelectTypeTabController", {
    ...
    afterInitialDataFetch: function(){
        ...
        this.ascBjUsmsProcAsgnCreateReqSelectTypeTabGrid.addParameter('prob_type', ZZFCommonController.probType);
        this.ascBjUsmsProcAsgnCreateReqSelectTypeTabGrid.refresh();
        if(this.ascBjUsmsProcAsgnReviewReqDS.getRecords().length!=0){
        	  this.ascBjUsmsProcAsgnReviewReqSelectTabGrid.addParameter('activityType', "activity_log.activity_type = '房屋协议管理-周转房'");
        }
...
function selectNextTab(requestType){
    View.getWindow('parent').View.setTitle("房屋协议管理-申请");
