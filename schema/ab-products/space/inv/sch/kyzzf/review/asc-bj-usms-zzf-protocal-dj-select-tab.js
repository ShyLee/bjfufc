...
var ascBjUsmsProcAsgnApproveReqSelectTabController = View.createController("ascBjUsmsProcAsgnApproveReqSelectTabController", {
    ...
    afterInitialDataFetch: function(){
        ...
        this.ascBjUsmsProcAsgnApproveReqSelectTabGrid.addParameter('activityType', "房屋协议管理-周转房");
        this.ascBjUsmsProcAsgnReviewReqSelectTabGrid.addParameter('actyType', "房屋协议管理-周转房");
...
function selectNextTab(){
    ...
    View.getWindow('parent').View.setTitle(probtType + "-" + stepType.substring(stepType.length - 2));
