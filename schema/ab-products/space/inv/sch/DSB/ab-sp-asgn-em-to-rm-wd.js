...
var controller = View.createController('abSpAsgnEmToRm_Controller', {
    ...
    afterInitialDataFetch: function(){
        ...
        var mainlayout=View.getLayoutManager('main');
	 	...
	 	var toolBarPanel;
	 	if(typeof(toolBarRegion)!="undefined"&&toolBarRegion!=null){
	 		toolBarPanel=toolBarRegion.layoutManager.getRegionPanel(toolBarRegion.region);
	 	}
   		
	 	if(typeof(dashboardTabsRegion)!="undefined"&&dashboardTabsRegion!=null){
	 		dashboardTabsPanel=dashboardTabsRegion.layoutManager.getRegionPanel(dashboardTabsRegion.region);
	 	}
   	 	var expandView = this.abSpAsgnEmToRm_drawingPanel.actions.get('showDwgView');
    ...
    abSpAsgnEmToRm_filterConsole_onShowTree: function(){
        ...
        var filterEmName = this.abSpAsgnEmToRm_filterConsole.getFieldValue('em.name');
		...
		if (filterEmName != "") {
			emGridRes.addClause("em.name", filterEmName + '%', "LIKE");
		}
    ...
    abSpAsgnEmToRm_filterConsole_onClear:function(){
    	this.abSpAsgnEmToRm_blTree.refreshClearAllFilters();
    	this.abSpAsgnEmToRm_emSelect.refreshClearAllFilters();
    }
