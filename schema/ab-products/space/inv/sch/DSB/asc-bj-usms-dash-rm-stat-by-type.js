...
var controller = View.createController('abScRmtypeChartPiebyRmcatController', {
	...
	refreshTypeGrid:function(){
		...
		//lab room
		//实验室
		this.abScRmtypebyRmcat_type2SumGrid.addParameter("rmcatRes","实验室");
		this.abScRmtypebyRmcatChartPie_rmtype2.addParameter("rmcatRes","实验室");
		...
		//党政管理办公用房
		this.abScRmtypebyRmcat_type4SumGrid.addParameter("rmcatRes","党政管理办公用房");
		this.abScRmtypebyRmcatChartPie_rmtype4.addParameter("rmcatRes","党政管理办公用房");
		this.abScRmtypebyRmcat_type4SumGrid.refresh();
		this.abScRmtypebyRmcatChartPie_rmtype4.refresh();
		
		
		//keyan room
		this.abScRmtypebyRmcat_type5SumGrid.addParameter("rmcatRes","科研用房");
		this.abScRmtypebyRmcatChartPie_rmtype5.addParameter("rmcatRes","科研用房");
		this.abScRmtypebyRmcat_type5SumGrid.refresh();
		this.abScRmtypebyRmcatChartPie_rmtype5.refresh();
	},
	...
	abScRmtypebyRmcat_type5SumGrid_rm_type_onClick: function(row){
		this.showBlHaveCatType(row);
	},
