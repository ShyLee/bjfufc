 ...
 * @author Keven.xi
 */
var ascBjUsmsDashRmStatbyDp = View.createController('ascBjUsmsDashRmStatbyDpController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-dash-rm-stat-by-dp_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-dash-rm-stat-by-dp-main-wd.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsDashRmStatbyDp.campusTabs.addTab(tab);
    tab.createTabPanel();
}
