...
//            parameters: {
//                'archiveId': archiveId,
//                'subReports':"emZfReg_sub"
//            },
//            closeButton: false
//        });
    },
    GridForm_onBtnUpdateZfEm: function(){
    	try{
    		var result = Workflow.callMethod("AbSpaceRoomInventoryBAR-UpdateZfEm-batchUpdateZfEmFromEm");
    		if(result.code='executed'){
    			View.panels.get('GridForm').restriction=null;
