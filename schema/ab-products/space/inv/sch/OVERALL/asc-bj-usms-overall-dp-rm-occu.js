 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallDeptOccu = View.createController('ascBjUsmsOverallDeptOccuController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-overall-dept-occu_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-dp-rm-occu-main.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallDeptOccu.campusTabs.addTab(tab);
    tab.createTabPanel();
}
