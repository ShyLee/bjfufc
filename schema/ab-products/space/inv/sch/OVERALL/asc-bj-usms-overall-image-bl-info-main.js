...
var imageMainController = View.createController('ascBjUsmsOverallImageBlInfoMainController', {
	...
	afterViewLoad:function(){
		...
		this.ascBjUsmsOverallOffBlInfoMain_blGrid.addParameter("labroomRes","实验室");
		this.ascBjUsmsOverallOffBlInfoMain_blGrid.addParameter("teachOfficeRoomRes","教师办公室");
		this.ascBjUsmsOverallOffBlInfoMain_blGrid.addParameter("officeRoomRes","办公室");
		this.ascBjUsmsOverallOffBlInfoMain_blGrid.addParameter("manageDvRes","党政管理办公用房");
		...
		this.locateBuilding_cadPanel_Main.appendInstruction("default", "", getMessage("falsh_headerMessage"));
	}
...
function highlightSelectedBuilding(){
    ...
    var blGrid = View.panels.get("ascBjUsmsOverallOffBlInfoMain_blGrid");
    var selectedRow = blGrid.rows[blGrid.selectedRowIndex];
    
    var highDs = View.dataSources.get("ds_ab-proj-projects-map_drawing_main_blHighlight");
    highDs.addParameter('blId', selectedRow['bl.bl_id']);
	var drawingPanel = View.getControl('', 'locateBuilding_cadPanel_Main');
