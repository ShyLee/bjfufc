...
View.createController('ascBjUsmsOverallRmWholeController', {
	...
	afterViewLoad:function(){
		...
		this.ascBjUsmsOverallRmWhole_rmcat1SumGrid.buildPostFooterRows = addTotalRowForNoServ;
		this.ascBjUsmsOverallRmWhole_rmcat2SumGrid.buildPostFooterRows = addTotalRowForHasServ;
	},
	...
	afterTabChange:function(tabPanel,selectedTabName,  newTabName){
		...
		if(selectedTabName == 'yiFenTan'){
			...
			//this.ascBjUsmsOverallRmWhole_rmcat2SumGrid.refresh({'bl.site_id':'02'});
...
//			this.ascBjUsmsOverallRmWhole_rmcat1SumGrid.buildPostFooterRows = addTotalRowForHasServ;
	...
	ascBjUsmsOverallRmWhole_siteBasicGrid_onFixedReport:function(){
		...
		//View.openDialog('asc-bj-usms-overall-rpt-rm-area-wd.axvw', null, false, {width:470, height:200, closeButton:false});
	}
...
function addTotalRowForHasServ(parentElement){
    ...
    addColumn(gridRow, 1, getMessage('total'),"left");
	// column 2: empty	
    addColumn(gridRow, 1);
