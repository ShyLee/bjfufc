var rplmBuildingController = View.createController('rplmBuilding008', {
    ...
    rplmBuildingForm_onGenerate: function(){
          ...
          try {
			var result = Workflow.callMethod('AbSolutionsWorkflow-iReportHandler-PmreReport','rmAreaReport-wd',txlspdf,parameters);
