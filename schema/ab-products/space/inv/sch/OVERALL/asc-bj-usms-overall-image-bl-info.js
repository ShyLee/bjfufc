 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallImageBlInfo = View.createController('ascBjUsmsOverallImageBlInfoController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-overall-image-bl-info_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-image-bl-info-main.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallImageBlInfo.campusTabs.addTab(tab);
    tab.createTabPanel();
}
