 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallEmRmByZhic = View.createController('ascBjUsmsOverallEmRmByZhicController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-overall-em-rm-by-zhic_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-em-rm-by-zhic-main.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallEmRmByZhic.campusTabs.addTab(tab);
    tab.createTabPanel();
}
