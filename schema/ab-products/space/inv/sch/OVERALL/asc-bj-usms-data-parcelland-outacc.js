...
//        this.updateSc_parcelland();//因为java后台已经自动修改状态了
	...
	refreshAfterXiaZhang:function(){
		...
		View.showMessage("土地：[" + this.curXZland_code + "] 已被移至下账表，下账成功!");
	},
	parcellandCansole_onClear:function(){
		this.parcellandGrid.refreshClearAllFilters();
	}
	/*
