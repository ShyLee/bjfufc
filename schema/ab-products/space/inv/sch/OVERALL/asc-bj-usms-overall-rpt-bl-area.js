var rplmBuildingController = View.createController('rplmBuilding007', {
   
    rplmBuildingForm_onGenerate: function(){
     var date =  this.rplmBuildingForm.getFieldValue("bl.date_bl");
	 var sname =  this.rplmBuildingForm.getFieldValue("bl.name");
	 var txlspdf = getSelectedRadioButton("lock");
		var parameters = 
		{
          ...
          try {
			...
			var result = Workflow.callMethod('AbSolutionsWorkflow-iReportHandler-PmreReport','blAreaReport',txlspdf,parameters);
