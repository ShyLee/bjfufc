 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallOffBlInfo = View.createController('ascBjUsmsOverallOffBlInfoController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-overall-off-bl-info_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-off-bl-info-main-wd.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallOffBlInfo.campusTabs.addTab(tab);
    tab.createTabPanel();
}
