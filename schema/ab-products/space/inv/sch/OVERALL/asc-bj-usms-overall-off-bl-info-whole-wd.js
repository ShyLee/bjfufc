 ...
 * @author Keven.xi
 */
View.createController('ascBjUsmsOverallOffBlInfoWholeController', {
	
	afterViewLoad:function(){
		this.ascBjUsmsOverallOffBlInfoWhole_blGrid.addParameter("classroomRes","教室");
		this.ascBjUsmsOverallOffBlInfoWhole_blGrid.addParameter("labroomRes","实验室、实习场所");
		this.ascBjUsmsOverallOffBlInfoWhole_blGrid.addParameter("manageDvRes","机关单位办公用房");
		this.ascBjUsmsOverallOffBlInfoWhole_blGrid.addParameter("teachDvRes","教学单位办公用房");
		this.ascBjUsmsOverallOffBlInfoWhole_blGrid.addParameter("vacantRmRes","空置房");
		
		this.ascBjUsmsOverallOffBlInfoWhole_blGrid.buildPostFooterRows = addTotalRowForBl;
	},
	
	ascBjUsmsOverallOffBlInfoWhole_siteBasicGrid_onShowSiteImage:function(){
		View.openDialog('asc-bj-usms-overall-image-bl-info.axvw', null, false, {width:1000, height:1200, closeButton:false});
		
	},
	
	ascBjUsmsOverallOffBlInfoWhole_blGrid_afterRefresh:function(){
		this.setStyle();
	},
	
	setStyle:function(){
		var rows = this.ascBjUsmsOverallOffBlInfoWhole_blGrid.rows;
