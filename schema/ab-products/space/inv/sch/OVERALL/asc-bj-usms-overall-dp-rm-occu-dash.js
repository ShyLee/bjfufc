 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallDeptOccuDash = View.createController('ascBjUsmsOverallDeptOccuDashController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-overall-dept-occu-dash_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-dp-rm-occu-dash-main.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallDeptOccuDash.campusTabs.addTab(tab);
    tab.createTabPanel();
}
