...
//        $("request_helpdesk_sla_request.prob_type").disabled = true;
        this.request.enableField("request_helpdesk_sla_request.activity_type",false);
        this.request.enableFieldActions("request_helpdesk_sla_request.activity_type",true);
        this.request.enableField("request_helpdesk_sla_request.prob_type,false);
        this.request.enableFieldActions("request_helpdesk_sla_request.prob_type",true);		
    }
});
