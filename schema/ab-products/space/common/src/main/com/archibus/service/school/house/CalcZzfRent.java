...
public class CalcZzfRent extends HelpdeskEventHandlerBase {
            ...
            for (final DataRecord record : records) {
                ...
                if (recordsBegin.isEmpty()) {
                    ...
                    final double otherPrice =
                            Double.valueOf(recordAll.getValue("sc_zzfcard.other_rent").toString());
                    ...
                    if (cardStatus.equals("yrz")
                        ...
                        if (cardType.equals("0")) {// ‘0’表示教职工合同
                            ...
                            othersPaymentHandle(firstDay, dateEnd, period, price, otherPrice,
                                cardId, area);
                        }
                        ...
                        final double rateYxq2 =
                                Double.valueOf(recordYxq.getValue("sc_zzf_renew.rate_two")
                                    .toString());
                        final String dateEndYxq =
                                recordYxq.getValue("sc_zzf_renew.date_end").toString();
                        if (cardType.equals("0")) {
                            ...
                            othersPaymentHandle(firstDay, dateEndYxq, period, priceYxq1,
                                otherPrice, cardId, area);
                        }
                    }
                }
            }
    ...
    public static void othersPaymentHandle(final String dateBegin, final String dateEnd,
            final String period, final double price, final double otherPrice, final String cardId,
        ...
        for (; ChylinDateUtils.dateCompare(dateBegin2, todayStr)
            ...
            if (ChylinDateUtils.dateCompare(dateEnd2, dateEnd)) {
                for (int i = 1; i <= flag; i++) {
                    ...
                    priceOfTheMonth = priceOfDay * day * area + otherPrice;
                    totalPrice += priceOfTheMonth;
    ...
    public static void saveEmployeeFeeRecord(final String dateBegin, final String dateEnd,
        ...
        sql.append(" rm_type, date_checkin, date_checkout,rate,price,area_lease,rent_period,date_pay_begin,date_pay_end,pay_ought,gzbm,address)");
        ...
        sql.append(" sc_zzfcard.rent_period,to_date('"
                ...
                + "','yyyy-mm-dd'),"
                + totalPrice
                + ",sc_zzfcard.gzbm,(select address from rm where rm.rm_id=sc_zzfcard.rm_id and rm.fl_id=sc_zzfcard.fl_id and rm.bl_id=sc_zzfcard.bl_id) as address");
    ...
    public static void saveOthersFeeRecord(final String dateBegin, final String dateEnd,
        ...
        final StringBuffer sql = new StringBuffer();
        sql.append("INSERT INTO sc_zzf_fee (card_id,em_id,em_id_z,em_name,identi_code,is_em, is_rc, bl_id, fl_id, rm_id,");
        sql.append(" rm_type, date_checkin, date_checkout,price,area_lease,rent_period,date_pay_begin,date_pay_end,pay_ought,gzbm,address)");
        sql.append(" SELECT sc_zzfcard.card_id,sc_zzfcard.em_id,sc_zzfcard.em_id_z,sc_zzfcard.em_name,sc_zzfcard.identi_code,sc_zzfcard.is_em,sc_zzfcard.is_rc,");
    ...
    public static void getMyGUID() {
        System.out.println("进入方法");
        final EventHandlerContext context = ContextStore.get().getEventHandlerContext();
        final JSONArray results = new JSONArray();
        final JSONObject guid = new JSONObject();

        guid.put("GUID", new RandomGUID());
        results.put(guid);
