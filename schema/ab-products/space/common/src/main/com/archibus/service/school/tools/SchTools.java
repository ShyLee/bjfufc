...
public final class SchTools extends HelpdeskEventHandlerBase {
    /**
     ...
     * @param field
     */
    public static void getUniquePKeyCode(final String flag, final String table, String key_field,
            final String sysDatefield) {
        final EventHandlerContext context = ContextStore.get().getEventHandlerContext();
        int year = 0;
        int month = 0;
        int day = 0;
        final Calendar c = Calendar.getInstance();// 获得系统当前日期
