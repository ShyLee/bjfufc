var spaceExpressHistory = View.createController('spaceExpressHistory', {
	...
	showHistoryByRoom: function(){
		...
		var roomRestriction =  "rmpct.bl_id ='" +bl_id+"'";
		roomRestriction =roomRestriction+ " AND rmpct.fl_id ='"+fl_id +"'";
		roomRestriction =roomRestriction+ " AND rmpct.rm_id ='"+rm_id+"' ";
		
		
		var roomRestriction2 =  "hrmpct.bl_id ='" +bl_id+"'";
		roomRestriction2 =roomRestriction2+ " AND hrmpct.fl_id ='"+fl_id +"'";
		roomRestriction2 =roomRestriction2+ " AND hrmpct.rm_id ='"+rm_id+"' ";
	    this.showHistoryList(roomRestriction,roomRestriction2);
	...
	showHistoryByEmployee: function(){
		...
		var emRestriction =  "rmpct.em_id ='" +em_id+"'";
		var emRestriction2 =  "hrmpct.em_id ='" +em_id+"'";
	    this.showHistoryList(emRestriction,emRestriction2);
		this.historyList.setTitle( getMessage('em')); 
	},

	showHistoryList: function(restrictionParameter,restrictionParameter2){
		this.historyList.addParameter('rmp', restrictionParameter);
		this.historyList.addParameter('hrmp',restrictionParameter2);
