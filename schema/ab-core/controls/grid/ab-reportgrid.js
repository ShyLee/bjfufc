...
/**/
    ...
    /**
     * 清除所有的parameter 和 restriction
     */
    refreshClearAllFilters:function(){
 	   if(this.parameters)
        this.clearParameters();
        
 	   this.refresh(null,null,true)
 	},
...
//	z_NOT_ALL_RECORDS_CAN_BE_SHOWN: 'Not all records are shown.',
	z_NOT_ALL_RECORDS_CAN_BE_SHOWN: '没有其它记录显示.',
	z_NOT_ALL_RECORDS_CAN_BE_SHOWN: 'Not all records can be shown.',
