...
<ab:view>
    ...
    <ab:message name="password_email_request_text">Send a change-password link to your work email?</ab:message>
    ...
    <ab:message name="evaluation_license_label_text">This is a limited time version of ARCHIBUS. Days left on your license: {0}</ab:message>
    ...
    <ab:html>
        ...
        <div id="logtext" style="width:1200px;height:80px;border:1px "></div>
        <div class="loginDialog">
            ...
            <div id="login_form" class="loginForm">
                <ol>
                    ...
                    <li>
                        <input class="loginTextBox loginControl" id="username_input" type="text" onFocus="showBlock('username_label');" onBlur="hideBlock('username_label');" onchange="handleUsername(); " tabindex="100"/>
                        <div class="inputHint" id="username_label">Usernames are not case-sensitive</div>
                    </li>
                    <li>
                        <input class="loginTextBox loginControl" id="password_input" type="password" onFocus="showBlock('password_label');" onBlur="hideBlock('password_label');" onchange="handlePassword();" tabindex="200"/>
            ...
            <div class="misc">
                <div class="misc-inner">
                    <div class="left-side">
                        ...
                        <a id="send_password_control" onClick="showBlock('lostPasswordCallout'); hideBlock('changeLocaleCallout');" style="display:none">I forgot my password</a>
                        
                        <div class="callout" id="lostPasswordCallout">
                            <div style="display:block; padding-bottom: 10px;" id="password_email_request">
                                Send a change-password link?
                            </div>
                            <div>
                                <input class="loginControl loginDialogButton" id="lost_password" type="button" title="Yes" accesskey="Y" value="Yes" tabindex="400" onClick="hideBlock('lostPasswordCallout');"/>
                                <input class="loginControl loginDialogButton" type="button" title="No" accesskey="N" value="No" tabindex="500"  onClick="hideBlock('lostPasswordCallout');"/>
                            </div>
                        ...
                        <a id="guest_button" style="display:none">Sign in as &ldquo;guest&rdquo;</a>
                        
                        <a id="localizeLink" class="localizeLink" style="display:none">
